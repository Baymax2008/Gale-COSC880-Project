...
class SystemsControllerTest < ActionController::TestCase
  ...
  test "should create system" do
    assert_difference('System.count') do
      post :create, system: { ato_Approval: @system.ato_Approval, ato_Doc: @system.ato_Doc, ato_Expiration: @system.ato_Expiration, ia_Approval: @system.ia_Approval, name: @system.name }
    end
  ...
  test "should update system" do
    patch :update, id: @system, system: { ato_Approval: @system.ato_Approval, ato_Doc: @system.ato_Doc, ato_Expiration: @system.ato_Expiration, ia_Approval: @system.ia_Approval, name: @system.name }
    assert_redirected_to system_path(assigns(:system))
  end
