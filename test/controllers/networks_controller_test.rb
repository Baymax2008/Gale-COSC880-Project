...
class NetworksControllerTest < ActionController::TestCase
  ...
  test "should create network" do
    assert_difference('Network.count') do
      post :create, network: { classification: @network.classification, experationDate: @network.experationDate, pocName: @network.pocName, pocNumber: @network.pocNumber }
    end
  ...
  test "should update network" do
    patch :update, id: @network, network: { classification: @network.classification, experationDate: @network.experationDate, pocName: @network.pocName, pocNumber: @network.pocNumber }
    assert_redirected_to network_path(assigns(:network))
  end
